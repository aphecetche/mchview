  ...
  view: () =>{
    return m('div.elementselector',
      ...
      m('input', {
        ...
        required: 'required',
        size: '4',
        value: ShowElement.deid,
        onchange: (e) => {
          if (e.target.validity.valid) {
            ShowElement.deid=e.target.value;
          }
        }
      })
    );
